...
export function Footer() {
  ...
  const footerBg = isDark ? "bg-[#0f0f1e]" : "bg-[#4C1D95]";
    ...
    <footer className={`${footerBg} text-white`}>
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            <h3 className="mb-4 text-lg font-bold">Plan Events</h3>
          ...
          <div>
            <h3 className="mb-4 text-lg font-bold">POAP Forge</h3>
            <ul className="space-y-2 text-sm text-white/80">
              <li>
          ...
          <div>
            ...
            <p className="mb-4 text-sm text-white/80">
              Get the latest updates on events and POAPs
            </p>
        ...
        <div className="mt-8 border-t border-white/10 pt-8 text-center text-sm text-white/60">
          <p>© 2026 POAP Forge — Ohana Protocol</p>
        </div>
      </div>
    </footer>
  );
